...
rose_api_error rose_vm::pset(int16_t x, int16_t y, uint8_t c)
{
...
rose_api_error rose_vm::pset_default(int16_t x, int16_t y)
{
    return pset(x, y, *pen_color_addr);
}

rose_api_error rose_vm::pget(int16_t x, int16_t y, uint8_t *res)
{
    coord_cam_offset(this, &x, &y);
...
rose_api_error rose_vm::palset(uint8_t idx, rose_color c)
{
...
rose_api_error rose_vm::palget(uint8_t idx, rose_color *res)
{
    auto slot = palette.begin + (idx * 3);
    res->r = *slot;
    res->g = *(slot + 1);
...
rose_api_error rose_vm::line(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint8_t c)
{
    if (y0 == y1)
    {
...
rose_api_error rose_vm::line_default(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
    return line(x0, y0, x1, y1, *pen_color_addr);
}

rose_api_error rose_vm::rect(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint8_t c)
{
...
rose_api_error rose_vm::rect_default(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
    return rect(x0, y0, x1, y1, *pen_color_addr);
}

int rect_clip(rose_vm *r, int16_t *x0, int16_t *y0, int16_t *x1, int16_t *y1)
{
...
rose_api_error rose_vm::rectfill(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint8_t c)
{
    rect_swap(&x0, &y0, &x1, &y1);
...
rose_api_error rose_vm::rectfill_default(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
    return rectfill(x0, y0, x1, y1, *pen_color_addr);
}

rose_api_error rose_vm::circ(int16_t x, int16_t y, uint16_t radius, uint8_t c)
{
    int16_t offx = radius;
    int16_t offy = 0;
...
rose_api_error rose_vm::circ_default(int16_t x0, int16_t y0, uint16_t radius)
{
    return circ(x0, y0, radius, *pen_color_addr);
}

rose_api_error rose_vm::circfill(int16_t x, int16_t y, uint16_t radius, uint8_t c)
{
    int16_t offx = radius;
    int16_t offy = 0;
...
rose_api_error rose_vm::circfill_default(int16_t x0, int16_t y0, uint16_t radius)
{
    return circfill(x0, y0, radius, *pen_color_addr);
}

rose_api_error fill_bottom_flat_triangle(rose_vm *r, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t c, bool fill)
{
...
rose_api_error fill_top_flat_triangle(rose_vm *r, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t c, bool fill)
{
...
rose_api_error tricommon(rose_vm *r, int16_t v0_x, int16_t v0_y, int16_t v1_x, int16_t v1_y, int16_t v2_x, int16_t v2_y, uint8_t c, bool fill)
{
...
rose_api_error rose_vm::tri(int16_t v0_x, int16_t v0_y, int16_t v1_x, int16_t v1_y, int16_t v2_x, int16_t v2_y, uint8_t c)
{
...
rose_api_error rose_vm::tri_default(int16_t v0_x, int16_t v0_y, int16_t v1_x, int16_t v1_y, int16_t v2_x, int16_t v2_y)
{
    return tri(v0_x, v0_y, v1_x, v1_y, v2_x, v2_y, *pen_color_addr);
}

rose_api_error rose_vm::trifill(int16_t v0_x, int16_t v0_y, int16_t v1_x, int16_t v1_y, int16_t v2_x, int16_t v2_y, uint8_t c)
{
    return tricommon(this, v0_x, v0_y, v1_x, v1_y, v2_x, v2_y, c, true);
}

rose_api_error rose_vm::trifill_default(int16_t v0_x, int16_t v0_y, int16_t v1_x, int16_t v1_y, int16_t v2_x, int16_t v2_y)
{
    return trifill(v0_x, v0_y, v1_x, v1_y, v2_x, v2_y, *pen_color_addr);
}

rose_api_error rose_vm::cls()
{
...
rose_api_error rose_vm::get_spritesheet_meta(uint32_t *addr, uint16_t *sheet_width, uint16_t *sheet_height, uint8_t *sprite_width_mult, uint8_t *sprite_height_mult)
{
...
rose_api_error rose_vm::set_spritesheet_meta(uint32_t addr, uint16_t sheet_width, uint16_t sheet_height, uint8_t sprite_width_mult, uint8_t sprite_height_mult)
{
    uint8_t *sprite_schema = schema.end - ROSE_MEMORY_SPRITE_SCHEMA_SIZE;
...
rose_api_error rose_vm::spr(uint32_t n, int16_t x, int16_t y, uint8_t w, uint8_t h, bool flip_x, bool flip_y)
{
    uint32_t addr;
...
rose_api_error rose_vm::print(string str, int16_t x, int16_t y, uint8_t c)
{
    int16_t _x = x;
    int16_t _y = y;
...
rose_api_error rose_vm::color(uint8_t c)
{
    *pen_color_addr = c;
    return ROSE_API_ERR_NONE;
}
