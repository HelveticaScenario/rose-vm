...
rose_api_error rose_vm::btn(uint8_t idx, bool* res) {
    *res = rose_get_bit(btn_states.begin, idx);
    return ROSE_API_ERR_NONE;
}

rose_api_error rose_vm::btnp(uint8_t idx, bool* res) {
...
rose_api_error rose_vm::wheel(int16_t* x, int16_t* y) {
...
rose_api_error rose_vm::wheel_inverted(bool* res) {
